    ...
    {#if register}
        <div class="signup">
            ...
            <form >
                ...
                {/if}
                <input type="text" name="password" placeholder="username" required on:keyup={() => onValidate(usernameInput, regEx.username)} bind:this={usernameInput}>
                <p>Invalid username!</p>
                <input type="email" name="email" placeholder="email" required on:keyup={() => onValidate(emailInput, regEx.email)} bind:this={emailInput}>
                <p>Invalid email!</p>
                
                <input type="password" name="password" placeholder="password" on:keyup={() => onValidate(passwordInput, regEx.password)} required bind:this={passwordInput}>
        ...
        <div class="signin">
            ...
            <form on:submit|preventDefault={login}>
                {#if authError}
                    <p class="error-text">{authErrorText}</p>
                {/if}
                <input type="text" name="email" placeholder="email" required on:keyup={() => onValidate(emailInput, regEx.email)} bind:this={emailInput}>
                <p>Invalid email!</p>
                
                <input type="password" name="password" placeholder="password" required bind:this={passwordInput}>
